"use strict";
var hooks = require("browser-sync/dist/hooks");
var asyncTasks = require("browser-sync/dist/async-tasks");
var config = require("browser-sync/dist/config");
var connectUtils = require("browser-sync/dist/connect-utils");
var utils = require("browser-sync/dist/utils");
var logger = require("browser-sync/dist/logger");
var eachSeries = utils.eachSeries;
var _ = require("browser-sync/dist/lodash.custom");
...
var defaultPlugins = {
    logger: logger,
    socket: require("browser-sync/dist/sockets"),
    "file:watcher": require("browser-sync/dist/file-watcher"),
    server: require("browser-sync/dist/server"),
    tunnel: require("browser-sync/dist/tunnel"),
...
BrowserSync.prototype.resetMiddlewareStack = function () {
    var bs = this;
    var middlewares = require("browser-sync/dist/server/utils").getMiddlewares(bs, bs.options);
