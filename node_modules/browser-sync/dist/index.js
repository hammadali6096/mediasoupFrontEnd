 ...
 * @module BrowserSync
 */
var pjson = require("browser-sync/package");
var BrowserSync = require("browser-sync/dist/browser-sync");
var publicUtils = require("browser-sync/dist/public/public-utils");
...
function create(name, emitter) {
    ...
    var instance = {
        ...
        exit: require("browser-sync/dist/public/exit")(browserSync),
        notify: require("browser-sync/dist/public/notify")(browserSync),
        pause: require("browser-sync/dist/public/pause")(browserSync),
        resume: require("browser-sync/dist/public/resume")(browserSync),
        reload: require("browser-sync/dist/public/reload")(emitter),
        stream: require("browser-sync/dist/public/stream")(emitter),
        ...
        watch: require("browser-sync/dist/file-watcher").watch
    };
    browserSync.publicInstance = instance;
    instance.init = require("browser-sync/dist/public/init")(browserSync, name, pjson);
